...
public class Rg implements ActionListener,FocusListener,MouseListener
{
	...
	public Rg() 
	{
		...
		jf.add(b[2]=new JButton("NJ"));
		b[2].setBounds(-10,50,101,55);
		b[2].setFont(new Font("Imprint MT Shadow",Font.BOLD,50));
		//b[2].getRootPane().setBackground(Color.BLUE);
		b[2].setForeground(Color.BLACK);
		//b[2].setBackground(Color.black);
		b[2].setToolTipText("NJ");
		b[2].setOpaque(false);
		b[2].setContentAreaFilled(false);
		b[2].setBorderPainted(false);
		
		jf.add(b[3]=new JButton(new ImageIcon("img\\Dj.jpg")));
		b[3].setBounds(180,190,900,200);
		b[3].setOpaque(false);
		b[3].setContentAreaFilled(false);
		b[3].setBorderPainted(false);
		
		jf.add(b[4]=new JButton("Try @ Home For Free ?"));
		b[4].setBounds(-75,10,310,50);
		b[4].setFont(new Font("Arial",Font.PLAIN,15));
		...
		jf.add(b[5]=new JButton("call-9352450920"));
		b[5].setBounds(140,10,200,50);
		b[5].setFont(new Font("Times New Roman",Font.PLAIN,20));
		...
		jf.add(b[6]=new JButton("My Account"));
		b[6].setBounds(1095,10,150,50);
		...
		l3.setBounds(1225,10,5,50);
		l3.setFont(new Font("Times New Roman",Font.BOLD,20));
		l3.setForeground(Color.lightGray);
	

		
		jf.add(b[7]=new JButton("WishList"));
		b[7].setBounds(1190,10,150,50);
		...
		jf.add(b[8]=new JButton(new ImageIcon("img\\rg.jpg")));
		b[8].setBounds(10,450,281, 281);
		b[8].setOpaque(false);
		b[8].setContentAreaFilled(false);
		b[8].setBorderPainted(false);
		
		jf.add(b[9]=new JButton(new ImageIcon("img\\necklace.jpg")));
		b[9].setBounds(370,450,281, 281);
		b[9].setOpaque(false);
		b[9].setContentAreaFilled(false);
		b[9].setBorderPainted(false);
		
		jf.add(b[10]=new JButton(new ImageIcon("img\\pd.jpg")));
		b[10].setBounds(700,450,281, 281);
		b[10].setOpaque(false);
		b[10].setContentAreaFilled(false);
		b[10].setBorderPainted(false);
		
		jf.add(b[11]=new JButton(new ImageIcon("img\\Er.jpg")));
		b[11].setBounds(1060,450,281, 281);
		b[11].setOpaque(false);
		b[11].setContentAreaFilled(false);
		b[11].setBorderPainted(false);
		
		jf.add(l4=new JLabel("______________________________"));
		l4.setBounds(1110,30,280,20);
		l4.setForeground(Color.lightGray);
		
		jf.add(BorderLayout.CENTER,jsp);
		jf.add(jmb=new JMenuBar());
		jmb.setBounds(150,120,1100,60);
	...
	public void mouseEntered(MouseEvent ae)
	{
		...
		jmb.setCursor(new Cursor(Cursor.HAND_CURSOR));
		 ...
		 b[11].setCursor(new Cursor(Cursor.HAND_CURSOR));
		 
		 
		 if(ae.getSource()==b[8])
		 {
			 b[8].setIcon(new ImageIcon("img\\RingsMd.jpg"));
		 }
		 if(ae.getSource()==b[9])
		 {
			 b[9].setIcon(new ImageIcon("img\\NecklaceMd2.jpg"));
		 }
		 if(ae.getSource()==b[10])
		 {
			 b[10].setIcon(new ImageIcon("img\\Pdmd.jpg"));
		 }
		 if(ae.getSource()==b[11])
		 {
			 b[11].setIcon(new ImageIcon("img\\EarMd.jpg"));
		 }
	}
	...
	public void mouseExited(MouseEvent ae) 
	{
		if(ae.getSource()==b[8])
		 {
			 b[8].setIcon(new ImageIcon("img\\rg.jpg"));
		 }
		 if(ae.getSource()==b[9])
		 {
			 b[9].setIcon(new ImageIcon("img\\necklace.jpg"));
		 }
		 if(ae.getSource()==b[10])
		 {
			 b[10].setIcon(new ImageIcon("img\\pd.jpg"));
		 }
		 if(ae.getSource()==b[11])
		 {
			 b[11].setIcon(new ImageIcon("img\\Er.jpg"));
		 }
